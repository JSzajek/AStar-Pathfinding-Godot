...
namespace AStar
{
    ...
    /// </summary>
    public class NavmeshAStarLinker : Dll, IAStarLinker
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="NavmeshAStarLinker"/> class.
        /// </summary>
        /// <param name="filePath">The file path to the dll</param>
        public NavmeshAStarLinker(string filePath) : base(filePath)
        {
